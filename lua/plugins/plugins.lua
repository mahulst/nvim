...
return { 
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>hy", function () require('harpoon.ui').nav_file(1) end, desc = "Go to harpoon 1" },
      { "<leader>hu", function () require('harpoon.ui').nav_file(2) end, desc = "Go to harpoon 2" },
      { "<leader>hi", function () require('harpoon.ui').nav_file(3) end, desc = "Go to harpoon 3" },
      { "<leader>ho", function () require('harpoon.ui').nav_file(4) end, desc = "Go to harpoon 4" },
